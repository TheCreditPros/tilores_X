...
// Import data service
import { fetchVirtuousCycleStatus, transformToDashboardData } from './services/dataService';
              ...
              <Box key={idx}>
                ...
                {metric.progress != null && (
                  <LinearProgress
                    ...
                    color={metric.progress > 90 ? 'success' : metric.progress > 80 ? 'primary' : 'warning'}
                  />
                )}
              </Box>
            ))}
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={3}>
          <Stack>
            ...
            <Typography variant="subtitle1" color="text.secondary">
              Self-Improvement Dashboard • Live Quality: {data.kpi?.qualityScore?.value || 'Loading...'}
            </Typography>
            {error && (
                ...
                <Stack spacing={2}>
                  <Alert severity="error" icon={<WarningAmber />}>
                    <Typography variant="body2">
                      <strong>HIGH:</strong> Edge case handling at 86.4% (below 90% threshold)
                    </Typography>
                  </Alert>
                  ...
                  <Alert severity="success" icon={<CheckCircle />}>
                    <Typography variant="body2">
                      <strong>INFO:</strong> Cycle #48 scheduled to start in 2 hours
                    </Typography>
                  </Alert>
                </Stack>
              </CardContent>
