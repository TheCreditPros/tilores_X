...
BATCH_SCENARIOS = [
    {
        ...
        "identifiers": ["john.smith@techcorp.com", "sarah.johnson@healthcare.org", "mike.brown@retail.com"],
        "expected_count": 3,
...
EDGE_CASES = [
    ...
    {"name": "Invalid email format", "query": "not-an-email", "expected_result": "no_results", "should_cache": False},
    {"name": "Partial phone number", "query": "555-123", "expected_result": "no_results", "should_cache": False},
    {
    ...
    {"name": "Very long query", "query": "a" * 1000, "expected_result": "error", "should_cache": False},
]

# Pre-warming configuration
PRE_WARM_CONFIG = {
    "high_priority_customers": ["john.smith@techcorp.com", "sarah.johnson@healthcare.org", "mike.brown@retail.com"],
    "common_searches": ["555-123-4567", "555-987-6543", "1881899", "003Ux000001hG4rIAE"],
